...
DATA_DIR = "data"
OUTPUT_FILE = os.path.join(DATA_DIR, "vietnam_macro_fred.json")
...
def main():
    ...
    if not FRED_API_KEY:
        ...
        # Create .env example if it doesn't exist (optional, but helpful)
        if not os.path.exists(".env"):
            with open(".env", "w") as f:
                f.write("FRED_API_KEY=your_api_key_here\n")
            print("   Created .env file. Please update it with your key.")
        return
